...
Chef::Recipe.send(:include, ::ChefTaskServer::Helpers)
Chef::Resource.send(:include, ::ChefTaskServer::Helpers)
Chef::Provider.send(:include, ::ChefTaskServer::Helpers)
